...
io.popen("mkdir TeAmSnaB_Files")
t = "\27[35m".."\nAll Files Started : \n____________________\n"..'\27[m'
i = 0
for v in io.popen('ls TeAmSnaB_Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
if hash or Bot(msg) or DevTeAmSnaB(msg) or TeAmSnaBDevSou(msg) then    
return true  
else  
return false  
end  
...
if hash or DevTeAmSnaB(msg) or DevBot(msg) or TeAmSnaBDevSou(msg) then     
return true 
else 
return false 
end 
...
if hash or DevTeAmSnaB(msg) or DevBot(msg) or TeAmSnaBDevSou(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
if hash or DevTeAmSnaB(msg) or DevBot(msg) or BasicConstructor(msg) or TeAmSnaBDevSou(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or DevTeAmSnaB(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or TeAmSnaBDevSou(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or DevTeAmSnaB(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or TeAmSnaBDevSou(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  DevTeAmSnaB(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or TeAmSnaBDevSou(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
if DevTeAmSnaBe(user_id) == true then
var = true
elseif DevTeAmSnaB(user_id) == true then
var = true
elseif TeAmSnaBDevSou(user_id) == true then
var = true
...
if tonumber(user_id) == tonumber(1740828176) then  
var = 'مطور السورس'
elseif DevTeAmSnaBe(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
...
local UserName = (data.username_ or "teamxsnab")
...
function TeAmSnaB_Files(msg)
for v in io.popen('ls TeAmSnaB_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("TeAmSnaB_Files/"..v)
if plugin.TeAmSnaB and msg then
pre_msg = plugin.TeAmSnaB(msg)
end
end
end
send(msg.chat_id_, msg.id_,pre_msg)  
end
function TeAmSnaB_Started_Bot(msg,data) -- بداية العمل
if msg then
...
local TeAmSnaB_Msg = database:sismember(bot_id.."List:Filter:text"..msg.chat_id_,text) 
if TeAmSnaB_Msg then    
...
function Function_TeAmSnaB(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TeAmSnaB, nil)
return false
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_TeAmSnaB, nil)
return false
end
...
if text == ("اضف مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and TeAmSnaBDevSou(msg) then
function Function_TeAmSnaB(extra, result, success)
...
if text and text:match("^اضف مطور ثانوي @(.*)$") and TeAmSnaBDevSou(msg) then
...
if text and text:match("^اضف مطور ثانوي (%d+)$") and TeAmSnaBDevSou(msg) then
...
if text == ("حذف مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and TeAmSnaBDevSou(msg) then
function Function_TeAmSnaB(extra, result, success)
...
if text and text:match("^حذف مطور ثانوي @(.*)$") and TeAmSnaBDevSou(msg) then
...
if text and text:match("^حذف مطور ثانوي (%d+)$") and TeAmSnaBDevSou(msg) then
...
if text == ("الثانويين") and DevTeAmSnaB(msg) then
...
if text == ("مسح الثانويين") and TeAmSnaBDevSou(msg) then
database:del(bot_id.."DEV:Sudo:T")
send(msg.chat_id_, msg.id_, "\n⋄︙تم مسح قائمة المطورين الثانويين  ")
end
if text == ("مسح قائمه العام") and DevTeAmSnaB(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("مسح المطورين") and DevTeAmSnaB(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("قائمه العام") and DevTeAmSnaB(msg) then
...
if text == ("المطورين") and DevTeAmSnaB(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTeAmSnaB(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevTeAmSnaB(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevTeAmSnaB(msg) then
...
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTeAmSnaB(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevTeAmSnaB(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام (%d+)$") and DevTeAmSnaB(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTeAmSnaB(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^اضف مطور @(.*)$") and DevTeAmSnaB(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^اضف مطور (%d+)$") and DevTeAmSnaB(msg) then
local userid = text:match("^اضف مطور (%d+)$")
database:sadd(bot_id.."Sudo:User", userid)
Reply_Status(msg,userid,"reply","⋄︙تم ترقيته مطور في البوت")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevTeAmSnaB(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حذف مطور @(.*)$") and DevTeAmSnaB(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حذف مطور (%d+)$") and DevTeAmSnaB(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local TeAmSnaBrt = database:get(bot_id.."Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if TeAmSnaBrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"⋄︙العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "TeAmSnaB_SoUrcE")..")".."\n⋄︙تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif TeAmSnaBrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"⋄︙العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "TeAmSnaB_SoUrcE")..")".."\n⋄︙تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif TeAmSnaBrt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"⋄︙العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "TeAmSnaB_SoUrcE")..")".."\n⋄︙تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."Manager"..msg.chat_id_,result.sender_user_id_)  
elseif TeAmSnaBrt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"⋄︙العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "TeAmSnaB_SoUrcE")..")".."\n⋄︙تم رفعه "..RTPA.." هنا\n")
end
end,nil)   
end   
...
if result.id_ then
local TeAmSnaBrt = database:get(bot_id.."Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if TeAmSnaBrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"⋄︙العضو > ["..result.title_.."](t.me/"..(text1[3] or "TeAmSnaB_SoUrcE")..")".."\n⋄︙تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⋄︙> العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'TeAmSnaB_SoUrcE')..') ~'
...
usertext = '\n⋄︙العضو > ['..result.title_..'](t.me/'..(username or 'TeAmSnaB_SoUrcE')..')'
status  = '\n⋄︙تم تقيده لمدة  { '..TextEnd[2]..' '..TextEnd[3]..'}'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⋄︙العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'TeAmSnaB')..') '
...
if text == ("مسح ردود المطور") and DevTeAmSnaB(msg) then 
...
if text == ("ردود المطور") and DevTeAmSnaB(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n⋄︙قائمة ردود المطور \n — — — — — — — — —\n"
for k,v in pairs(list) do
...
if text == "اضف رد للكل" and DevTeAmSnaB(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "حذف رد للكل" and DevTeAmSnaB(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
},function(ta,TeAmSnaB)
local t = "\n*⋄︙قائمة الاعضاء \n ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n*"
x = 0
local list = TeAmSnaB.members_
for k, v in pairs(list) do
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'teamxsnab')..')'
...
local UserName = (b.username_ or "teamxsnab")
...
if database:get(bot_id.."Status:Bc") and not DevTeAmSnaB(msg) then 
...
if text == "تنظيف المشتركين" and DevTeAmSnaB(msg) then
...
if text == "تنظيف الكروبات" and DevTeAmSnaB(msg) then
...
if text == ("تحديث السورس") and DevTeAmSnaB(msg) then  
send(msg.chat_id_,msg.id_,'⋄︙تم التحديث')
os.execute('rm -rf TeAmSnaB.lua')
os.execute('rm -rf start.lua')
os.execute('wget https://raw.githubusercontent.com/TeAmSnaBv/master/TeAmSnaB.lua')
os.execute('wget https://raw.githubusercontent.com/TeAmSnaBv/master/start.lua')
dofile('TeAmSnaB.lua')  
return false
end
if text == "راسلني" then
...
if text == 'السيرفر' and DevTeAmSnaB(msg) then 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- SnaB SoUrce .',url="t.me/teamxsnab"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text and text:match("^تعين عدد الاعضاء (%d+)$") and DevTeAmSnaB(msg) then
...
if text == 'جلب نسخه احتياطيه' and DevTeAmSnaB(msg) then
local list = database:smembers(bot_id..'Chek:Groups')  
local memo = database:smembers(bot_id..'UsersBot')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
...
if text == 'نقل الاحصائيات' and DevTeAmSnaB(msg) then
...
if text == 'حذف كليشه المطور' and DevTeAmSnaB(msg) then
database:del(bot_id..'Text_Dev')
send(msg.chat_id_, msg.id_,'⋄︙تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and DevTeAmSnaB(msg) then
...
if text == 'رفع النسخه الاحتياطيه' and DevTeAmSnaB(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == "تحديث" and DevTeAmSnaB(msg) then
dofile("TeAmSnaB.lua")  
send(msg.chat_id_, msg.id_, "⋄︙تم التحديث")
end

                if text == 'السورس' or text == 'سورس' or text == 'ياسورس' or text == 'يا سورس' then       
Text = "[𝘞𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 ـ SnaB SoUrce ـ ](t.me/teamxsnab)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ـ SnaB SoUrce ـ  .',url="https://t.me/teamxsnab"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
if text == 'تفعيل الردود' and Addictive(msg) then  
send(msg.chat_id_, msg.id_, '🗳¦ تم تفعيل الردود')
database:del(bot_id..'lock:add'..msg.chat_id_)
end
if text == 'تعطيل الردود' and Addictive(msg) then  
...
if text == 'اريد بوت' or text == 'اريد مطور' or text == 'خوش سورس' or text == 'سورس سناب' or text == 'اريد بوت تمبلر' or text == 'سورس سناب' then
Text = [[
•- DEV @UUssUU مبرمج بوتات•
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
الاستفسار راسل المطور السورس @UUssUU
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
⌯ اضغط ( اوامر التسليه ) لرؤيتها 
 —ـ—ـ—ـ—ـ—ـ—ـ—ـ—ـ—
•[- TeAM - SnaB ♪](t.me/teamxsnab)• •
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- 1⃣ -', callback_data="/help1"},{text = '- 2⃣ -', callback_data="/help2"},{text = '- 3⃣ -', callback_data="/help3"}},
{{text = '- 4⃣ -', callback_data="/help4"},{text = '- 5⃣ -', callback_data="/help6"}},
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevTeAmSnaB(msg) then
...
if text == '/start' then  
if DevTeAmSnaB(msg) then
local Text =  '-  WelCoMe SnaB - المطور الاساسي \n- سورس سناب\n- يمكنك التحكم في الكيبورد من الاسفل\n- [تابع جديدنا](t.me/teamxsnab) '
local keyboard = {
{'📮 - الاحصائيات','☢️ - تغيير المطور الاساسي'},
{'🔓 - تفعيل التواصل','🔏 - تعطيل التواصل'},
{'🗑️ - تنظيف الكروبات','🔄 - تنظيف المشتركين'},
...
if not DevTeAmSnaB(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."Filter"..msg.sender_user_id_) then
...
if DevTeAmSnaB(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text =='☢️ - تغيير المطور الاساسي' and TeAmSnaBDevSou(msg) then
send(msg.chat_id_, msg.id_,'⋄︙ارسل ايدي المطور الاساسي الجديد')
database:set(bot_id..'Ed:DevBots',true) 
end
if text =='☢️ - تغيير المطور الاساسي' and not TeAmSnaBDevSou(msg) then
send(msg.chat_id_, msg.id_,'⋄︙تسرسح')
end
if text == ("مسح الثانويين ⋄") and not TeAmSnaBDevSou(msg) then
send(msg.chat_id_, msg.id_,'⋄︙تسرسح')
end
if text == ("مسح الثانويين ⋄") and TeAmSnaBDevSou(msg) then
database:del(bot_id.."DEV:Sudo:T")
...
if text and text:match("^- تغير الاشتراك ⋄ .$") and DevTeAmSnaB(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '⋄︙حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^- تغير رساله الاشتراك ⋄ .$") and DevTeAmSnaB(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '⋄︙حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ⋄ ." and DevTeAmSnaB(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "⋄︙تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^- تعين قناة الاشتراك ⋄ .$") and DevTeAmSnaB(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '⋄︙حسنآ ارسل لي معرف القناة')
return false  
end
if text == "- تفعيل الاشتراك الاجباري ⋄ ." and DevTeAmSnaB(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "- تعطيل الاشتراك الاجباري ⋄ ." and DevTeAmSnaB(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "⋄︙تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "- الاشتراك الاجباري ⋄ ." and DevTeAmSnaB(msg) then  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- 2⃣ -', callback_data="/help2"},{text = 'الاوامر الرئيسيه', callback_data="/help"}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- 3⃣ -', callback_data="/help3"},{text = 'الاوامر الرئيسيه', callback_data="/help"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
if DAata == '/help3' then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- 4⃣ -', callback_data="/help4"},{text = 'الاوامر الرئيسيه', callback_data="/help"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
if DAata == '/help4' then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- 5⃣ -', callback_data="/help5"},{text = 'التسليه', callback_data="/help10"}},
...
keyboard.inline_keyboard = {
{{text = '- 1⃣ -', callback_data="/help1"},{text = '- 2⃣ -', callback_data="/help2"},{text = '- 3⃣ -', callback_data="/help3"}},
{{text = '- 4⃣ -', callback_data="/help4"},{text = '- 5⃣ -', callback_data="/help5"}},
...
------------------------------------------------------------------------
if text then
local TeAmSnaB_Msg = database:sismember(bot_id.."List:Filter:text"..result.chat_id_,text) 
if TeAmSnaB_Msg then    
